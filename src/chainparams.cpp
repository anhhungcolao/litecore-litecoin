...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1526020600, 858280, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5e1b6f90dcf1ebfabf0056fc373f0171aa08740c32683a290e1b0471a9dbcd01"));
        ...
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.mycoin.loshan.co.uk", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("mycointools.com", "dnsseed.mycointools.com"));
        // vSeeds.push_back(CDNSSeedData("mycoinpool.org", "dnsseed.mycoinpool.org"));
	...
	checkpointData = (CCheckpointData) {
		boost::assign::map_list_of
			(  0, uint256S("0x5e1b6f90dcf1ebfabf0056fc373f0171aa08740c32683a290e1b0471a9dbcd01"))
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1526020578, 137730, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9a6646930fc9f46d75ef4a2881d0c2aba2f4b885325f2d016494c8b966e84021"));
        assert(genesis.hashMerkleRoot == uint256S("0x52b2455696516c14fde6fb8bf13891f34a49b339b99aa863942e5cd54db71fc1"));
        ...
        // vSeeds.push_back(CDNSSeedData("mycointools.com", "testnet-seed.mycointools.com"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mycoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x9a6646930fc9f46d75ef4a2881d0c2aba2f4b885325f2d016494c8b966e84021")),
            1526020578,
            0,
            1.0
        };
